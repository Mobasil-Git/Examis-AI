        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: const Icon(Icons.document_scanner_outlined, size: 64,
  ...
  Widget _buildTemplateList(BuildContext context, TemplateProvider provider) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return Padding(
          padding: EdgeInsets.only(bottom: isLastItem ? 120.0 : 16.0),
          // Nav Bar Bumper!
          child: Container(
            decoration: BoxDecoration(
            ...
            child: ListTile(
              ...
              leading: Container(
                ...
                child: const Icon(
                    Icons.description_rounded, color: AppColors.primary),
              ),
              title: Text(
              ...
              trailing: IconButton(
                icon: const Icon(
                    Icons.delete_outline_rounded, color: AppColors.error),
                onPressed: () async {
                  ...
                  if (rawId != null) {
                    ...
                    bool success = await provider.deleteTemplate(rawId);
